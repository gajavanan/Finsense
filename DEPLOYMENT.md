...
| `PYTHON_VERSION` | Stable Python runtime | `3.12.8` |
...
| `FRONTEND_URL` | Production Vercel domain | `https://finsense.vercel.app` |
| `ALLOWED_ORIGINS` | Comma-separated allowed CORS origins | `https://finsense.vercel.app` |
| `EMAIL_PROVIDER` | Email provider selection | `smtp` |
| `SMTP_HOST` | Transactional email SMTP server | `smtp.gmail.com` |
| `SMTP_PORT` | SMTP port | `587` |
| `SMTP_USERNAME` | SMTP authentication user / email | `your-notifications-email@gmail.com` |
| `SMTP_PASSWORD` | App-specific password (not master password) | `<YOUR_16_CHAR_GMAIL_APP_PASSWORD>` |
| `SMTP_FROM_EMAIL` | From address for outgoing emails | `your-notifications-email@gmail.com` |
